...
url_psn = [
    ...
    "https://store.playstation.com/pt-br/product/UP0006-CUSA12539_00-SWJFOSTANDARD000",
    ...
    "https://store.playstation.com/pt-br/product/UP0001-CUSA00663_00-AC4GAMEPS4000001",
    "https://store.playstation.com/pt-br/product/UP9000-CUSA11456_00-GHOSTSHIP0000001",
    "https://store.playstation.com/pt-br/product/UP0006-CUSA02684_00-ME4RECRUITSTNDRD",
    ...
    for u in urls:
        ...
        if len(u):
            ...
            if games:
                ...
                prizes[gamename][name] = money
            else:
                prizes[gamename][name] = "-----"
        else:
            prizes[gamename][name] = "-----"
        index += 1
        sleep(0.5)
...
scrap("PSN", url_psn, "span", "psw-h3", "")

arq = open("prizes.txt", "w")
arq.write("JOGO;ZOOM;Amazon;PSN\n")

for name in names:
    arq.write(name + ";")
    arq.write(prizes[name]["ZOOM"] + ";")
    arq.write(prizes[name]["Amazon"] + ";")
    arq.write(prizes[name]["PSN"] + ";")
    arq.write("\n")
